...
function Box1(x, y, w, h, confettiColor, p){
    var options = {
        friction: 0.2,
        frictionAir: 0.02,
        restitution: 0.5,
    ...
    // let img;
    // img = p.loadImage('../buttontest.png')
    ...
    this.removeFromWorld = function() {
      ...
      this.inField = function(){
        ...
        var pos = this.body.position;
        return (pos.y < 0 - (matterWindowHeight/2));
...
function Circle(x, y, r, confettiColor, p){
    var options = {
        friction: 0.2,
        frictionAir: 0.02,
        restitution: 0.5,
...
function PhysicsBlock(x, y, w, h, confettiColor, p){
    ...
    this.show = function(){
        ...
        htmlBlock.style.transform = "translateY("+(pos.y-(matterWindowHeight/2)-(blockHeight/4))+"px) translateX("+(pos.x+(matterWindowWidth/2)-(blockWidth/2))+"px) rotate("+angle+"rad)";
...
function PhysicsBlock2(x, y, w, h, confettiColor, p){
    var options = {
        friction: 0.2,
        frictionAir: 0.02,
        restitution: 0.5,
    ...
    this.show = function(){
        ...
        let htmlBlock;
        htmlBlock = document.getElementById("htmlBlock2");
        // console.log(htmlBlock.offsetHeight);
        let blockWidth = htmlBlock.offsetWidth;
        let blockHeight = htmlBlock.offsetWidth;
        // htmlBlock.translate(pos.x, pos.y);
        // console.log(pos.x);
        // htmlBlock.style.top = pos.y;
        htmlBlock.style.transform = "translateY("+(pos.y-(matterWindowHeight/2)-(blockHeight/4)-90)+"px) translateX("+(pos.x+(matterWindowWidth/2)-(blockWidth/2))+"px) rotate("+angle+"rad)";
        // htmlBlock.style.transform = "";
        // console.log("rotate("+pos.y+")");
        // console.log(htmlBlock.style.top);
        // htmlBlock.style.left = pos.x;
